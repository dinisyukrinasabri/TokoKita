...
class BarangModel
{
	...
	{
		$this->db->query('SELECT IdBarang, NamaBarang, Keterangan, Satuan, a.IdPengguna, b.NamaPengguna FROM barang a JOIN pengguna b ON a.IdPengguna = b.IdPengguna ORDER BY a.IdBarang ASC');
